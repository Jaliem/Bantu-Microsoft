...
* **AI Chatbot (Azure OpenAI):**
  Asisten cerdas berbasis Azure OpenAI yang membantu pengguna dalam berbagai kebutuhan, seperti:

  * Menjawab pertanyaan seputar proyek
  * Memberikan rekomendasi skill atau pekerjaan
  * Membantu mahasiswa memahami requirement tugas
  * Mendukung UMKM dalam membuat keputusan cepat

* **AI SOP Generator (Azure OpenAI):**
  Fitur ini memungkinkan UMKM untuk secara otomatis menghasilkan **Standard Operating Procedure (SOP)** atau deskripsi kerja yang terstruktur hanya dari input sederhana.
  Manfaat:

  * Memperjelas ekspektasi proyek
  * Mengurangi miskomunikasi
  * Meningkatkan kualitas hasil kerja
  * Membantu UMKM yang belum terbiasa membuat brief profesional
...
* **AI Integration:** Azure OpenAI (GPT-based model)
* **Ikon:** [Lucide React](https://lucide.dev/)
* **Karusel:** [Embla Carousel](https://www.embla-carousel.com/)
* **Deployment:** [Vercel](https://bantu-microsoft.vercel.app/)
...
* Akses Azure OpenAI (untuk fitur AI)
...
1. Klon repositori:
   ...
   ```bash
   git clone https://github.com/Vernandio/Bantu---IOFest.git
   cd Bantu---IOFest
   ```
